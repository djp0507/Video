                    ...
                    try {
                        ...
                        if(jsonObject.length()>0){
                            if(0==jsonObject.getInt("code")){
                                mView.registerResultError(jsonObject.getString("msg"));
                        ...
                        try {
                            ...
                            if(jsonObject.length()>0){
                                ...
                                if(1==jsonObject.getInt("code")){
                                    mView.imageUploadFinlish(jsonObject.getString("msg"));
                                    return;
                                }else{
                                    ToastUtils.shoCenterToast(jsonObject.getString("msg"));
                                }
                            }else{
                                mView.imageUploadError();
                            }
                        } catch (JSONException e) {
                            mView.imageUploadError();
                            e.printStackTrace();
