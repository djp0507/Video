...
public class SearchResultUserFragment extends BaseFragment<FragmentSearchLayoutBinding> implements BaseQuickAdapter.RequestLoadMoreListener, SearchUserContract.View
    ...
    private SearchUserPresenter mUserListPresenter;
    ...
    public static SearchResultUserFragment newInstance(OnSearchListener onSearchListener){
    ...
    protected void initViews() {
        mUserListPresenter = new SearchUserPresenter(getActivity());
    ...
    private void initHistoryListAdapter() {
        ...
        mHistorySearchAdapter.setOnDeleteOneItemListener(new HistorySearchAdapter.OnDeleteOneItemListener() {
            ...
            public void onSearch(String key,int type) {
                searchListener.onSearch(key,type,1);
            }
        });
        initFooterView();
    }
    ...
    private void loadMoreUserList() {
        mPage++;
        mUserListPresenter.getMoreUserList(searchKey,searchKeyType+"",mPage+"",mPageSize+"");
    }
    ...
    public void onDestroy() {
        ...
        mSearchResultUserAdapter=null;searchListener=null;
        mHistorySearchAdapter=null;searchKey=null;mUserListPresenter=null;mCanelLayoutBinding=null;
        super.onDestroy();
    }
