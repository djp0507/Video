...
public class SearchResultAllFragment extends BaseFragment<FragmentSearchLayoutBinding> implements BaseQuickAdapter.RequestLoadMoreListener, SearchVideoContract.View
        ,VideoComentClickListener {

    public static final String TAG=SearchResultAllFragment.class.getSimpleName();
    ...
    protected void initViews() {
        mSearchVideoPresenter = new SearchVideoPresenter(getActivity());
        mSearchVideoPresenter.attachView(this);
        try {
            initHistoryListAdapter();
            initSearchResultAdapter(0);
        }catch (Exception e){
            Log.d("SearchResultAllFragment", "onViewCreated: e="+e.getMessage());
        }
    }
    ...
    private void loadMoreVideoList() {
        mPage++;
        mSearchVideoPresenter.getMoreVideoList(searchKey,searchKeyType+"",mPage+"",mPageSize+"");
    }
    ...
    private void initHistoryListAdapter() {
        ...
        mHistorySearchAdapter.setOnDeleteOneItemListener(new HistorySearchAdapter.OnDeleteOneItemListener() {
            ...
            public void onSearch(String key,int type) {
                searchListener.onSearch(key,type,0);
            }
        });
        initFooterView();
    }
    ...
    public void showErrorView() {
        Log.d("SearchResultAllFragment", "showErrorView: ");
    }
    ...
    public boolean resultIsShow() {
        return bindingView.recyerView.getVisibility()==View.VISIBLE;
    }
    ...
    public void onDestroy() {
        if(null!=mSearchVideoPresenter){
            mSearchVideoPresenter.detachView();
        }
        ...
        headerLayoutBinding=null;mSearchVideoPresenter=null;
        searchListener=null;searchKey=null;mCanelLayoutBinding=null;
        super.onDestroy();
    }
