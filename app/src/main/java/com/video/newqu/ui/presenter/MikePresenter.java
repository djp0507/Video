...
public class MikePresenter extends RxPresenter<MakePasswordContract.View> implements MakePasswordContract.Presenter<MakePasswordContract.View> {
    ...
    private static final String TAG = MikePresenter.class.getSimpleName();
                    ...
                    try {
                        ...
                        if(jsonObject.length()>0){
                            ...
                            if(1==jsonObject.getInt("code")){
                                mView.makePasswordFinlish(jsonObject.getString("msg")+",请使用新密码登录");
                            //修改密码失败
                            }else{
                                mView.makePasswordError(jsonObject.getString("msg"));
                            }
                        }
