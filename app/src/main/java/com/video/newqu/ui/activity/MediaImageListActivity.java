...
public class MediaImageListActivity extends BaseActivity<ActivityVideoListBinding> implements View.OnClickListener, BaseQuickAdapter.RequestLoadMoreListener {

    private ImageListAdapter mImageListAdapter;
    private static ArrayList<PhotoInfo> pitchPhotoInfos;//已经选中的相册列表
    public static  int MAX_IMAGE_NUM=3;//默认最大可选择图片数量为3张
    ...
    private void initAdapter() {
        ...
        mImageListAdapter.setOnLoadMoreListener(this);
    }
    ...
    private void close() {
        ...
        if(null!=mImageListAdapter){
            ...
            if(null!=data&&data.size()>0){
                ...
                ToastUtils.shoCenterToast("未发现照片");
                finish();
            }
        }
    }
