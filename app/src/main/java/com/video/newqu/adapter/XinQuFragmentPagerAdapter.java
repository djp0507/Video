...
public class XinQuFragmentPagerAdapter extends android.support.v4.app.FragmentPagerAdapter {
     ...
     * 普通，主页使用
     */
    public XinQuFragmentPagerAdapter(FragmentManager fm, List<Fragment> mFragment) {
        super(fm);
     ...
     * 接收首页传递的标题
     */
    public XinQuFragmentPagerAdapter(FragmentManager fm, List<Fragment> mFragment, List<String> mTitleList) {
        super(fm);
        this.mFragment = mFragment;
