...
public abstract class BaseMineFragment<VS extends ViewDataBinding> extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View ll = inflater.inflate(R.layout.fragment_mine_base, null);
    ...
    protected void lookMusicDetailsList(String musicID) {
