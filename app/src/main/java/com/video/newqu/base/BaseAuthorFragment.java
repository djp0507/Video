...
import com.video.newqu.databinding.FragmentBaseAuthortBinding;
...
public abstract class BaseAuthorFragment<VS extends ViewDataBinding> extends Fragment {

    // 子布局view
    protected VS bindingView;
    protected AppCompatActivity context;
    protected LoadingProgressView mLoadingProgressedView;
    protected FragmentBaseAuthortBinding baseBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        baseBinding=DataBindingUtil.inflate(getActivity().getLayoutInflater(),R.layout.fragment_base_authort,null,false);
        ...
        if(null!=bindingView){
            ...
            baseBinding.reConttentView.addView(bindingView.getRoot());
        }
