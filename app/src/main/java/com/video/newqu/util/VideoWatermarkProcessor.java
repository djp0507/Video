...
public class VideoWatermarkProcessor {
    ...
    private static final String TAG = VideoWatermarkProcessor.class.getSimpleName();
    ...
    private class VideoWaterMarkComposeTask extends Thread {
         ...
         */
        public void execute() {
            Logger.d(TAG,"resourceFilePath="+resourceFilePath);
            if(null!=mEditKtiWeakReference&&null!=mEditKtiWeakReference.get()){
                ...
                Logger.d(TAG,"composeUrl="+composeUrl.toString());
