...
public class UserPlayerVideoHistoryList implements Parcelable,Comparable<UserPlayerVideoHistoryList>{
    ...
    private static final String TAG = UserPlayerVideoHistoryList.class.getSimpleName();
    ...
    @Generated(hash = 1206084530)
    public UserPlayerVideoHistoryList(Long ID, int id, String userName,
            String userSinger, String userCover, String videoDesp,
            String videoLikeCount, String videoCommendCount,
            String videoShareCount, String userId, String videoId,
            String videoCover, boolean isSelector, String uploadTime, long addTime,
            int is_interest, int is_follow, String videoPath,
            String videoPlayerCount, String videoType, String downloadPermiss) {
        this.ID = ID;
        this.id = id;
    ...
    public int compareTo(@NonNull UserPlayerVideoHistoryList o) {
        return addTime>o.getAddTime()?1:0;
    }
}
