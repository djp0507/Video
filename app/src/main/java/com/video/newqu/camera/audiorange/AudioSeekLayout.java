package com.video.newqu.camera.audiorange;
...
public class AudioSeekLayout extends LinearLayout {
    ...
    public static final String TAG="AudioSeekLayout";
    ...
    public AudioSeekLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        LayoutInflater.from(context).inflate(R.layout.media_edit_audio_seek, this, true);
    }
    ...
    protected void onFinishInflate() {
        ...
        ImageView btn_audio_close = (ImageView) findViewById(R.id.btn_audio_close);
        ImageView btn_empty_music = (ImageView) findViewById(R.id.btn_empty_music);
            ...
            public void onClick(View v) {
                ...
                if(id==R.id.btn_audio_close){
                    if(null!=mOnClickViewListener){
                        mOnClickViewListener.onCloseAudioView();
                    }
                    return;
                }else if(id==R.id.btn_empty_music){
                    if(null!=mOnClickViewListener){
                        mOnClickViewListener.onCanelMusic();
                    }
                }
            }
        };
        btn_audio_close.setOnClickListener(onClickListener);
        btn_empty_music.setOnClickListener(onClickListener);
    }
    ...
    public void updateAudioSeekUI(float bgmLength, float previewLength) {
        ...
        final int minMarginLeft = (int) (11 * mScreenDensity);
        Logger.d(TAG,"minMarginLeft"+minMarginLeft);
