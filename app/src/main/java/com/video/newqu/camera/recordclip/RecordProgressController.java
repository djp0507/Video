...
public class RecordProgressController {
     ...
     */
    public RecordProgressController(RecordProgressView rootView) {
        mHandler = new Handler();
        mProgressView =rootView;
    ...
    public boolean isPassMinPoint() {
        ...
        return recordedTime >= MediaRecordActivity.MIN_DURATION;
    }
    ...
    public int getRecordedTime() {
        return mProgressView.mTotalWidth * MediaRecordActivity.MAX_DURATION / mProgressView
                .mScreenWidth;
    }
