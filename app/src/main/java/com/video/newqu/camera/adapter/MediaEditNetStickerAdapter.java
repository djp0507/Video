...
public class MediaEditNetStickerAdapter extends BaseMultiItemQuickAdapter<StickerNetInfo.DataBean,StickerViewHolder> {
    ...
    public MediaEditNetStickerAdapter(List<StickerNetInfo.DataBean> data, OnMediaStickerListener onMediaStickerListener) {
        super(data);
        ...
        //将素材存储在内部缓存
        mStickerImagePath = new File(Constant.PATH_DATA+"/Sticker");
...
//                setHeaderItemData(helper,item);
     ...
     * @param item
     */
//    private void setHeaderItemData(StickerViewHolder helper, StickerNetInfo.DataBean item) {
...
//                    mOnMediaStickerListener.onRemoveAllStickers();
//                }
//            }
//        });
//    }
     ...
     * @param item
     */
    private void setItemData(StickerViewHolder helper, StickerNetInfo.DataBean item) {
